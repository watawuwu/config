((Enhanced-Ruby-Mode status "removed" recipe nil)
 ...
 (anything-show-completion status "removed" recipe nil)
 ...
 (applescript-mode status "removed" recipe nil)
 (auto-pair+ status "removed" recipe nil)
 ...
 (direx status "removed" recipe nil)
