...
(defcustom org-export-html5presentation-title-format "<!--<h1 class=\"title\">%s</h1>-->\n"
...
the second the HOME link.  If both `org-export-html5presentation-link-up' and
`org-export-html5presentation-link-home' are empty, the entire snippet will be
ignored."
  :group 'org-export-html5presentation
  :type 'string)
...
(defcustom org-export-html5presentation-validation-link nil
...
(defvar org-export-html5presentation-preamble nil
  "Preamble, to be inserted just after <body>.  Set by publishing functions.
This may also be a function, building and inserting the preamble.")
(defvar org-export-html5presentation-postamble nil
...
(defvar org-export-html5presentation-auto-preamble t
  "Should default preamble be inserted?  Set by publishing functions.")
(defvar org-export-html5presentation-auto-postamble t
      ...
      (let* ((filename path)
         ...
         (if (and
            ...
            (progn
               ...
               (org-export-html5presentation-format-image thefile org-par-open))
            (concat
               "<a href=\"" thefile "\"" attr ">"
...
;; "
;;                  (format
;;                   (or (and (stringp org-export-html5presentation-xml-declaration)
;;                            org-export-html5presentation-xml-declaration)
;;                       (cdr (assoc html-extension org-export-html5presentation-xml-declaration))
;;                       (cdr (assoc "html" org-export-html5presentation-xml-declaration))
;;                       "")
...
;;                    "")))
        ...
        (org-export-html5presentation-insert-plist-item opt-plist :preamble opt-plist)
...
;;                                     (org-html5presentation-expand title))))
      ...
      (if (and nil (not body-only))
          (progn
            (push (format "<h%d>%s</h%d>\n"
                          org-export-html5presentation-toplevel-hlevel
                          (nth 3 lang-words)
                          org-export-html5presentation-toplevel-hlevel)
                  thetoc)
      ...
      (while (setq line (pop lines) origline line)
        (catch 'nextline
          ...
          (org-export-html5presentation-close-lists-maybe line)
            ...
            (when (string-match
              ...
              (cond
               ((and starter
                ...
                (org-close-par-maybe)
                (insert (cond
                         ;; ((equal item-type "u") "<ul class=\"summary\">\n<li>\n")
                         ((equal item-type "u") "<ul class=\"summary\">\n<li>\n")
                         ((equal item-type "o")
                          (if initial-number
                              ;; (format "<ol class=\"summary\" start=%s>\n<li>\n" initial-number)
                              (format "<ol class=\"summary\" start=%s>\n<li>\n" initial-number)
                            "<ol class=\"summary\">\n<li>\n"))
                         ((equal item-type "d")
                          (format "<dl>\n<dt>%s</dt><dd>\n" item-tag))))
      ...
      (unless t ;body-only
        (when (plist-get opt-plist :auto-postamble)
          ...
          (when org-export-html5presentation-validation-link
            (insert org-export-html5presentation-validation-link "\n"))
          (insert "</div>"))

        (if org-export-html5presentation-with-timestamp
            (insert org-export-html5presentation-html-helper-timestamp))
        (org-export-html5presentation-insert-plist-item opt-plist :postamble opt-plist)
        ;; (insert "\n</div>\n</body>\n</html>\n"))
        )
        (insert
"
...
(defun org-export-html5presentation-insert-plist-item (plist key &rest args)
...
(defun org-html5presentation-do-expand (s)
  ...
  (if org-export-html-expand            ;org-export-html5presentation-expand
      (while (string-match "@&lt;\\([^&]*\\)&gt;" s)
...
(defun org-export-html5presentation-convert-special-strings (string)
  ...
  (let ((all org-export-html-special-string-regexps) ;org-export-html5presentation-special-string-regexps
        e a re rpl start)
...
(defun org-export-html5presentation-close-lists-maybe (line)
...
(defun org-html5presentation-level-start (level title umax with-toc head-count)
